<?php if (!is_404()): ?>
	...
	$copyright = get_theme_mod('footer_copyright', wp_kses(__("Copyright &copy; 2019-2020 Adworld Theme by <a href='https://adworld.link' target='_blank'>AWG</a>. All rights reserved", 'adworld'), array('a' => array('href' => array(), 'target' => array()))));
	$footer_class = '';
